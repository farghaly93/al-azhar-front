...
export class AdminMainPageComponent implements OnInit {
  ...
  links = [
    ...
    {path: '/admin-panel/offers/published', name: "الأعلانات المنشورة", icon: "fa fa-ad"},
    {path: '/admin-panel/offers/suspended', name: "الأعلانات المعلقة", icon: "fa fa-ad"},
    ...
    {path: '/admin-panel/album', name: "ألبوم الصور", icon: "fa fa-location"},
  ];
